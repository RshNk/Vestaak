        ...
        <section id="blog-single" class="notoppadding">
            <div class="section-inner clearfix">
                ...
                <div class="blog-content wrapper">
                   ...
                   <p>
                       مدیریت نیروی انسانی شرکت یکی از مهم ترین بخش های هر شرکت بزرگ و کوچکی است اگر تعداد کارمندان شما از ۳ هم بیشتر شود مدیریت زمان ها و فعالیت های آنان بسیار سخت خواهد شد . این نرم افزار به شما کمک خواهد کرد تا تمام این کار های دردسر آفرین را به راحتی انجام دهید.
                       <br>
                       در کنار این سیستم میتوانید مدیریت پروژه های داخل شرکتتان را نیز به خلاقانه ترین سیستم مدیریت پروژه ایجاد شده بسپارید.
                   </p>
                    ...
                    <h6 class="alttitle">
                        <strong>با ابزار حرفه ای راحت تر مدیریت کنید.</strong>
                    </h6>
            ...
            <div class="horizontalinner wrapper">
                ...
                <div class="column-section clearfix">
                    <div class="column one-third align-center">
                        ...
                        <h6 class="title-minimal" data-bigletter="پ"><strong>بدون اتلاف وقت</strong></h6>
                        <p style="text-align: center">سریع به آنچه میخواهید برسید</p>
                    </div>
                    <div class="column one-third align-center">
