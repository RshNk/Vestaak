...
<title>Blog Single 3 | Pond | Creative One Page Template</title>
<!-- DEFAULT META TAGS -->
	...
	<header id="header" class="non-overlay">        
		<div class="header-inner clearfix">
			...
			<div class="fixed-header-content"> 
				<h1 id="header-name" class="alttitle title-minimal left-float"><strong>Post Without Header</strong></h1>
           ...
           <!-- DEFAULT HEADER CONTENT -->
		   	<div class="default-header-content">                 
				<div id="logo" class="left-float">
					<a id="default-logo" class="logotype" href="index.html"><img src="/images/vestaak-light.png" alt="Logo"></a>
	...
	<section id="page-title">
		<div class="section-inner wrapper align-center">
			...
			<div class="blog-headline">
				<span class="time">Nov 11, 2014</span>
		...
		<section id="blog-single" class="notoppadding">
			<div class="section-inner wrapper-small clearfix">	 
				...
				<ul class="single-pagination fixed-pagination">
					<li class="next"><a href="blog1.blade.php" class="transition" data-name="The Beauty of North Carolina">
					<i class="pagination-icon"></i> Next Post <i class="pagination-icon"></i></a></li>
					<li class="prev"><a href="blog2.blade.php" class="transition" data-name="Selfhosted Audio File">
