...
<title>Blog Single 2 | Pond | Creative One Page Template</title>
<!-- DEFAULT META TAGS -->
           ...
           <!-- DEFAULT HEADER CONTENT -->
		   	<div class="default-header-content">                 
				<div id="logo" class="left-float">
					<a id="default-logo" class="logotype" href="index.html"><img src="/images/vestaak.png" alt="Logo"></a>
					<a id="fixed-logo" class="logotype" href="index.html"><img src="/images/vestaak.png" alt="Logo"></a>
				</div>    
				
				<div class="menu right-float clearfix">
					<a href="#" class="open-nav nav-dark"><span></span></a>
					<nav id="main-nav" class="text-light">
						<div class="nav-logo"><img src="/images/vestaak-light.png" alt="Logo"></div>
						<div class="nav-inner">
						<ul>
						...
						<li  class="current-menu-item"><a href="blog.blade.php" data-bigletter="B">Blog</a></li>
	...
	<section id="page-title" class="parallax" data-parallax-image="/images/1690x1100-light.jpg">
		<div class="section-inner wrapper align-center">
			...
			<div class="blog-headline">
				...
				<h4 class="post-name title-minimal"><strong>Selfhosted Audio File</strong></h4> 
			</div>
			
			<!-- Place your Media in the Page Title Section if wanted (in this case add a width) -->				
							...
							jQuery("#jquery_jplayer_audio1").jPlayer({
								ready: function () {
									jQuery(this).jPlayer("setMedia", {
										mp3: "http://spab-rice.com/wordpress/iris/wp-content/images/2012/05/test.mp3",
										oga: "http://spab-rice.com/wordpress/iris/wp-content/images/2012/05/test.ogg",
										end: ""
									});
								},
								swfPath: "/jplayer",
		...
		<section id="blog-single">
			<div class="section-inner wrapper-small clearfix">	 
				...
				<div id="blog-comments" class="clearfix">
					...
					<h5 data-bigletter="3"><strong>Comments</strong></h5>
					<div class="separator-small right-float"><span></span></div>
						
					<ul class="comment-list">
						<li class="comment" >
							<div class="comment-inner">
								<div class="user">
									<img src="http://0.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=50" class='avatar' height='50' width='50' alt="avatar" />
								</div>
								
								<div class="comment-content">
									
									<h6 class="comment-name alttitle title-minimal"><strong>Thom Y.</strong> <span class="time">Jan 26, 2014</span></h6>
							...
							<ul class="children">
								<li class="comment" >
									<div class="comment-inner">
										...
										<div class="comment-content">
											<h6 class="comment-name alttitle title-minimal"><strong>Massive A.</strong> <span class="time">Jan 28, 2014</span></h6>
					   ...
					   <li class="comment" >
					   		<div class="comment-inner">
								...
								<div class="comment-content">
									<h6 class="comment-name alttitle title-minimal"><strong>Kurt C.</strong> <span class="time">Feb 28, 2014</span></h6>
				...
				<div id="blog-leavecomment" class="clearfix">
					...
					<h5 data-bigletter="L"><strong>Leave a comment</strong></h5>
					<div class="separator-small right-float"><span></span></div>
					...
					<form action="#" method="post" id="commentform">
						...
						<div class="form-row clearfix last-formrow">
							<label for="website">Website</label>
							<input type="text" name="website" class="website" id="website" value="" placeholder="Website" />
						</div>
						...
						<div class="form-row clearfix textbox">
							...
							<textarea name="comment_form" class="comment_form" id="comment_form" rows="15" cols="50" placeholder="Comment *"></textarea>
						</div>
				...
				<!-- LEAVE COMMENT --> 
         		...
         		<div class="spacer spacer-big"></div> <!-- adding spacing for the footer section -->
				
				<!-- Single Pagination -->
				<ul class="single-pagination fixed-pagination">
					<li class="next"><a href="blog3.blade.php" class="transition" data-name="Post Without Header">
					<i class="pagination-icon"></i> Next Post <i class="pagination-icon"></i></a></li>
					<li class="prev"><a href="blog1.blade.php" class="transition" data-name="The Beauty of North Carolina">
